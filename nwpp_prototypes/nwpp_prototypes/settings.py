"""
Django settings for nwpp_prototypes project.
...
SECRET_KEY = 'uat@6i$i-938($7)@ceg%cr!*w-f_pnrwdtigy4is!3%cn)sqd'
...
ROOT_URLCONF = 'nwpp_prototypes.urls'
...
WSGI_APPLICATION = 'nwpp_prototypes.wsgi.application'
